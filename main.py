...
class Liberacao_seguranca(QMainWindow, Ui_Liberacao_Seguranca):
    ...
    # def verificaCheckList(self):
    #     if self.checkBox_1.isChecked() and self.checkBox_2.isChecked() and self.checkBox_3.isChecked() and self.checkBox_4.isChecked() and self.checkBox_5.isChecked() and self.checkBox_6.isChecked() and self.checkBox_7.isChecked() and self.checkBox_8.isChecked() and self.checkBox_9.isChecked():
    #             print('tudo lindo')
